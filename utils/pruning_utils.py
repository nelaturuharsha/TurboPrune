...
class PruningStuff:
    ...
    def create_train_loader(self, batch_size: int, num_workers: int, data_root: str, dataset_name: str) -> Any:
    ...
    @param("dataset.dataset_name")
    def acquire_model(self, model_name: str, num_classes: int, dataset_name: str) -> nn.Module:
    ...
    def prune_at_initialization(self, er_method: str, er_init: float, model: nn.Module) -> nn.Module:
